...
public class FileUtil {
    ...
    private static final String ROOT_DIR = ".kky";
    private static final String DOWNLOAD_DIR = "download";
    private static final String CACHE_DIR = "cache";
    private static final String ICON_DIR = "icon";

    private static final String CONFIG_FILE = ".merchant";
    ...
    public static void writeProperties(String key, String value) {
        ...
        writeProperties(getDir(CONFIG_DIR) + File.separator + CONFIG_FILE, key, value, key);
    }
    ...
    public static String readProperties(String key) {
        return readProperties(getDir(CONFIG_DIR) + File.separator + CONFIG_FILE, key, "");
    }
    ...
    public static Map<String, String> readMap(String filePath, String defaultValue) {
        ...
        try {
            ...
            Properties p = new Properties();
            p.load(fis);
            map = new HashMap<>((Map) p);// 因为properties继承了map，所以直接�?�过p来构造一个map
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            IOUtil.close(fis);
    ...
    public static String getPathFromURI(Uri contentUri) {
        ...
        Cursor cursor = UIUtil.getContext().getContentResolver().query(contentUri, proj, null, null, null);
